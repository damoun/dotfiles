...
<meta http-equiv="content-type" content="text/html; charset=ISO-8859-1">
  ...
  <body linkifytime="60" linkified="4" linkifying="false">
    <pre><span class="comment-delimiter">;;; </span><span class="comment">php-mode.el --- major mode for editing PHP code
</span>
...
</span><span class="comment-delimiter">;; </span><span class="comment">X-URL:   <a class="linkification-ext" href="http://php-mode.sourceforge.net/" title="Linkification: http://php-mode.sourceforge.net/">http://php-mode.sourceforge.net/</a>
</span>
...
<span class="comment-delimiter">;; </span><span class="comment">To make php-mode compatible with html-mode, see <a class="linkification-ext" href="http://php-mode.sf.net/" title="Linkification: http://php-mode.sf.net">http://php-mode.sf.net</a>
</span>
...
(<span class="keyword">eval-when-compile</span>
  (<span class="keyword">require</span> '<span class="constant">regexp-opt</span>))</pre><hr><pre><span class="comment-delimiter">;; </span><span class="comment">Local variables
...
(<span class="keyword">defcustom</span> <span class="variable-name">php-manual-url</span> <span class="string">"<a class="linkification-ext" href="http://www.php.net/manual/en/" title="Linkification: http://www.php.net/manual/en/">http://www.php.net/manual/en/</a>"</span>
...
(<span class="keyword">defcustom</span> <span class="variable-name">php-search-url</span> <span class="string">"<a class="linkification-ext" href="http://www.php.net/" title="Linkification: http://www.php.net/">http://www.php.net/</a>"</span>
...
Turning this on will force PEAR rules on all PHP files."</span>
  <span class="builtin">:type</span> 'boolean
  <span class="builtin">:group</span> 'php)</pre><hr><pre>(<span class="keyword">defconst</span> <span class="variable-name">php-mode-modified</span> <span class="string">"2008-11-04"</span>
...
(<span class="keyword">defun</span> <span class="function-name">php-mode-version</span> ()
  ...
  (message <span class="string">"PHP mode %s of %s"</span>
           php-mode-version-number php-mode-modified))</pre><hr><pre>(<span class="keyword">defconst</span> <span class="variable-name">php-beginning-of-defun-regexp</span>
...
</pre><hr><pre>(<span class="keyword">defvar</span> <span class="variable-name">php-warned-bad-indent</span> nil)
...
(<span class="keyword">defun</span> <span class="function-name">php-cautious-indent-line</span> ()
  (<span class="keyword">if</span> (or php-warned-bad-indent
          (php-check-html-for-indentation))
      (funcall 'c-indent-line)))</pre><hr><pre>(<span class="keyword">defconst</span> <span class="variable-name">php-tags</span> '(<span class="string">"&lt;?php"</span> <span class="string">"?&gt;"</span> <span class="string">"&lt;?"</span> <span class="string">"&lt;?="</span>))
...
<span class="comment-delimiter">;;   </span><span class="comment">(c-lang-defconst c-class-decl-kwds
  ...
  (run-hooks 'php-mode-hook))</pre><hr><pre><span class="comment-delimiter">;; </span><span class="comment">Make a menu keymap (with a prompt string)
...
(define-key php-mode-map
  ...
  '(<span class="string">"Search documentation"</span> . php-search-documentation))</pre><hr><pre><span class="comment-delimiter">;; </span><span class="comment">Define function name completion function
...
(<span class="keyword">defun</span> <span class="function-name">php-show-arglist</span> ()
  ...
  (<span class="keyword">let*</span> ((tagname (php-get-pattern))
    ...
    (<span class="keyword">if</span> arglist
        ...
        (message <span class="string">"Unknown function: %s"</span> tagname))))</pre><hr><pre><span class="comment-delimiter">;; </span><span class="comment">Define function documentation function
...
<span class="comment-delimiter">;; </span><span class="comment">Define shortcut
  ...
  '[(control .)]
  'php-show-arglist)</pre><hr><pre>(<span class="keyword">defconst</span> <span class="variable-name">php-constants</span>
  (<span class="keyword">eval-when-compile</span>
    (regexp-opt
...
(<span class="keyword">defconst</span> <span class="variable-name">php-superglobals</span>
  ...
  <span class="doc">"PHP superglobal variables."</span>)</pre><hr><pre><span class="comment-delimiter">;; </span><span class="comment">Set up font locking
